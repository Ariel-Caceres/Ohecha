            ...
            <div className="flex  justify-start p-5 pl-6 w-1/2 items-center">
                ...
                <div className="w-1/2 justify-between  ">
                    <ul className=" flex justify-around m-0 p-0 items-center ">
                        ...
                        <li className="m-0 p-0 cursor-pointer hover:text-white">Continue Watching</li>
